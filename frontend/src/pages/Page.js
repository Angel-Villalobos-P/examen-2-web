            ...
            <div className="container-fluid">
                <div className="row vh-100">
                    <div className="navops col-2 nav d-flex flex-column  ">
                        <button type="button" className="btn btn-light mb-4" onClick={() => handleClickClientes()}>Clientes</button>
                        <button type="button" className="btn btn-light mb-4" onClick={() => handleClickProductos()}>Productos</button>
                        <button type="button" className="btn btn-light mb-4" onClick={() => handleClickInventario()}>Inventario</button>
                        <button type="button" className="btn btn-light mb-4" onClick={() => handleClickFacturacion()}>Facturacion</button>
                        <button type="button" className="btn btn-light mb-4" onClick={() => handleClickTipoPago()}>Tipo de Pago</button>
                    </div>
